                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo $root; ?>category/create.php">
                                <i class="fas fa-list text-warning"> </i>
                                <span class="">Category</span>
                            </a>

                            <a class="dropdown-item d-flex align-items-center" href="<?php echo $root . 'product'; ?>">
                    ...
                    <!-- Account -->
                    <a type="button" href="<?php echo $root; ?>edit.php" class="btn btn-warning me-3 text-white">
